...
export class PricingPageComponent implements OnInit {
  ...
  features: Feature[] = [
    {icon: 'fa-dollar', name: 'Base Development Fee', description: 'This includes outlining functionality, designing the mockups, and general development fee for the app.', cost: 2000, active: true},
